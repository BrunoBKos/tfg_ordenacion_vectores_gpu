...
int main(void) {
  ...
  if(ret) {
    ...
    printf("Input:   ");
    for(int i = 0; i < 20; i++) printf(" %d", h_input[i+(Elems/2)]);
    /* for(int i = 0; i < Arrs; i++) */
    /*   for(int j = 0; j < Elems; j++) */
    /* printf(" %d", h_input[i*Elems+j]); */
    printf(" ...\n"); 
    printf("CPU calculated:   ");
    for(int i = 0; i < 20; i++) printf(" %d", h_output_sec[i+(Elems/2)]);
    /* for(int i = 0; i < Arrs; i++) */
    /*   for(int j = 0; j < Elems; j++) */
    /* printf(" %d", h_output_sec[i*Elems+j]); */
    printf(" ...\n"); 
    printf("GPU calculated:   ");
    for(int i = 0; i < 20; i++) printf(" %d", h_output_par[i+(Elems/2)]);
    /* for(int i = 0; i < Arrs; i++) */
    /*   for(int j = 0; j < Elems; j++) */
